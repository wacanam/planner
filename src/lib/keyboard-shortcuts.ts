...
export const RECORDS_SHORTCUTS: ShortcutDefinition[] = [
  {
    id: 'records-tab-notebook',
    key: '1 or Alt+1',
    label: 'My Notebook',
    description: 'Switch to personal return visits notebook',
    category: 'records',
    keys: ['1'],
  },
  {
    ...
    key: '2 or Alt+2',
    label: 'Doors Directory',
    description: 'Switch to Doors tab',
    category: 'records',
    keys: ['2'],
  },
  {
    ...
    key: '3 or Alt+3',
    label: 'Door Visits',
    description: 'Switch to Door Visits log tab',
    category: 'records',
    keys: ['3'],
  },
  {
    ...
    description: 'Switch to Do Not Call registry tab',
    category: 'records',
    keys: ['4'],
  },
  {
    ...
    description: 'Switch to Shared doors tab',
    category: 'records',
    keys: ['5'],
  },
  {
