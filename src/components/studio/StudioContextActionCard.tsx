...
> = {
  pointer: {
    ...
    instruction:
      'Tap any household, road, or boundary to edit. Right-click vertices on selected roads/boundaries to delete them.',
    icon: MousePointer,
    doneLabel: 'Done',
  },
  boundary: {
    ...
    instruction:
      'Tap around the perimeter. Click the green start dot or Complete Boundary to close and fill. Right-click vertices to delete.',
    icon: Hexagon,
  ...
  road: {
    ...
    instruction:
      'Tap along the street to draw route lines. Snaps to existing roads as Y, T, or X junctions. Right-click vertices to delete.',
    icon: Milestone,
    doneLabel: 'Save Road',
  },
  pin: {
